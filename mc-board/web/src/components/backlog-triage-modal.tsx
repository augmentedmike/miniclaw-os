    ...
    <Modal onClose={onClose}>
            ...
            <div style={{ padding: "8px 12px", borderBottom: "1px solid #18181b", display: "flex", alignItems: "center", gap: 8, flexShrink: 0 }}>
              ...
              {testLog && (
                <button
                  ...
                  style={{ fontSize: 13, color: copied ? accent : "#52525b", background: "none", border: "none", cursor: "pointer", padding: "0 2px", lineHeight: 1 }}
      ...
      <div className="border-t border-zinc-800 px-6 py-4 flex items-center gap-3 flex-shrink-0">
        <span className="text-xs text-zinc-600 flex-1">
          <code className="text-zinc-500">~/.openclaw/miniclaw/USER/brain/prompts/backlog-triage.txt</code>
        </span>
        <button
          onClick={handleTest}
