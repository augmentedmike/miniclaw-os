...
const JOBS_FILE = process.env.BOARD_CRON_JOBS ?? "/Users/augmentedmike/am/cron/jobs.json";
const RUNS_DIR = process.env.BOARD_CRON_RUNS ?? "/Users/augmentedmike/am/cron/runs";
