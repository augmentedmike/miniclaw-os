      ...
      <div className="modal form-modal" role="dialog" aria-modal="true">
        ...
        <form onSubmit={submit}>
          <div className="modal-body">
            ...
            <div className="form-field">
              <label className="form-label" htmlFor="contact-trust">
                Trust Status
              </label>
              <select
                id="contact-trust"
...
function ContactModal({
  ...
  return (
    <div
      className={`backdrop ${contact ? "open" : ""}`}
      onMouseDown={e => {
        if (e.target === e.currentTarget) onClose();
      }}
    >
          ...
          <div className="modal-header">
            ...
            <div className="modal-header-info">
              ...
              <div className="modal-meta">
                <span className={trustClass(contact.trustStatus)}>
                  {trustLabel(contact.trustStatus)}
                </span>
                {(contact.tags ?? []).map(t => (
  ...
  return (
    <div className="app-body">
      ...
      <div className="top-bar">
        <div className="brand">Rolodex</div>
        <div className="stat-pills">
          <div className="stat-pill">
            contacts <b>{data?.total ?? "…"}</b>
          </div>
          {activeTag && (
            <div className="stat-pill">
              tag: <b>{activeTag}</b>
          ...
          {activeTrust && (
            <div className="stat-pill">
              trust: <b>{activeTrust}</b>
            </div>
          )}
        </div>
        <div className="top-bar-actions">
          <button className="btn-new" onClick={() => setFormMode("new")}>
            + New Contact
          </button>
        </div>
      </div>
      ...
      <div className="rolodex-main">
        ...
        <div className="filter-panel">
          ...
          <button
            className={`filter-btn ${!activeTrust ? "active" : ""}`}
          ...
          {TRUST_LEVELS.map(level => (
            ...
            >
              {level}
              {trustCounts[level] != null && (
                <span className="filter-count">{trustCounts[level]}</span>
              )}
            </button>
          ))}
              ...
              contacts.map(c => (
                ...
                >
                  ...
                  <div className="contact-right">
                    <span className={trustClass(c.trustStatus)}>
                      {trustLabel(c.trustStatus)}
                    </span>
                    {(c.tags?.length ?? 0) > 0 && (
      ...
      {/* Footer */}
      <div className="footer">mc-rolodex · port 4221</div>
